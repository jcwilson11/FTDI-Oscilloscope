...
% added by Joris Wilson for images
\usepackage{wrapfig}
\usepackage{graphicx}
...
2dsnFTDI_Design,
3dsnCH3,
3UsabilitySecurityETC,
4dsnCH4,
4dsnArchPatterns,
5dsnCH5,
5dsnLibSepResp,
8dsnCH8,
8dsnMultithreadedPipeline,
9dsnCH9,
9dsnUtilityTree,
10dsnCH10,
%1dsnUserStories,
...
\singlespacing
\include{1dsnCH1}
\include{1dsnExercise4_1}
\include{1dsnExercise4_2}
\include{1dsnExercise4_3}
\include{1dsnDiagramPython}
\include{1dsnExercise4_5}
\include{2dsnCH2}
\include{2dsnRequirements}
%\include{dsnRequirements}
\include{2dsnUseCases}
\include{2dsnCRC_Classes}
\include{2dsnFTDI_Design.tex}
\include{3dsnCH3}
\include{3UsabilitySecurityETC}
\include{4dsnCH4}
\include{4dsnArchPatterns}
\include{5dsnCH5}
\include{5dsnLibSepResp}
\include{8dsnCH8}
\include{9dsnCH9}
\include{10dsnCH10}
%\include{1dsnUserStories}
%\include{1dsnDocHistory}
%\include{2dsnCH2}
%\include{2dsnExercise}
%\include{dsnUseCases}
...
\appendix
\include{dsnWeeklyReports}

%\makeglossaries 0dsnManual -- from command prompt.
\clearpage
\printglossaries
