...
\begin{itemize}
    ...
    \begin{figure}[!htbp]
      \centering
      \IfFileExists{svg/io_scope_process.svg}{
        \includesvg[width=1.0\linewidth]{svg/io_scope_process.svg}
      }
      \caption{Process View}
      \label{fig:io_scope_process}
    \end{figure}
    ...
    \begin{figure}[!htbp]
      \centering
      \IfFileExists{svg/io_scope_physical.svg}{
        \includesvg[width=1.0\linewidth]{svg/io_scope_physical.svg}
      }
      \caption{Physical View}
      \label{fig:io_scope_physical}
    \end{figure}
    Purpose: Physical view showing the runtime environment, FTDI DLL dependency, and hardware deployment context.

    \begin{figure}[!htbp]
      \centering
      \IfFileExists{svg/io_scope_scenario_sequence.svg}{
        \includesvg[width=1.0\linewidth]{svg/io_scope_scenario_sequence.svg}
      }
      \caption{Scenario Sequence}
      \label{fig:io_scope_scenario_sequence}
    \end{figure}
