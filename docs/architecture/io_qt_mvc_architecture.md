...
## 4+1 Artifact Set
- Logical view: [io_scope_logical_class.puml](../plantuml/io_scope_logical_class.puml)
- Logical readable view: [io_scope_logical_class_readable.puml](../plantuml/io_scope_logical_class_readable.puml)
- Process view: [io_scope_process.puml](../plantuml/io_scope_process.puml)
- Development view: [io_scope_development.puml](../plantuml/io_scope_development.puml)
